			...
			<form method="post" class="ajax-form"  autocomplete="off">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group has-feedback relative-wrap">
								<label for="reg_password" class="bold"><?php esc_html_e( 'Password *', 'adifier' ) ?> <span class="pw-strength"></span></label>
								<input type="password" class="form-control reveal-password pw-check-strength" id="reg_password" name="reg_password" placeholder="<?php esc_attr_e( 'Use a strong password', 'adifier' ) ?>" />
								<a href="javascript:;" title="<?php esc_attr_e( 'View Password', 'adifier' ) ?>" class="toggle-password"><i class="aficon-eye"></i></a>
							</div>
						</div>
						<div class="col-sm-6">
					...
					<div class="text-center">
						<a href="#" class="forgot" data-toggle="modal" data-target="#resend" data-dismiss="modal"><?php esc_html_e( 'Resend verification?', 'adifier' ) ?></a>
					</div>
				...
				<div class="modal-body">
					...
					<?php if( !empty( $_GET['rec_hash'] ) && !empty( $_GET['login'] ) ): ?>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group has-feedback relative-wrap">
									<label for="rec_password" class="bold"><?php esc_html_e( 'Password *', 'adifier' ) ?> <span class="pw-strength"></span></label>
									<input type="password" class="form-control reveal-password pw-check-strength" id="rec_password" name="rec_password" placeholder="<?php esc_attr_e( 'Use a strong password', 'adifier' ) ?>" />
									<a href="javascript:;" title="<?php esc_attr_e( 'View Password', 'adifier' ) ?>" class="toggle-password"><i class="aficon-eye"></i></a>
								</div>
							</div>
							<div class="col-sm-6">
...
<div class="modal in lrr" id="resend" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<form method="post" class="ajax-form"  autocomplete="off">
				<div class="modal-header">
					<h5 class="modal-title"><?php esc_html_e( 'Resend Verification', 'adifier' ) ?></h5>
					<a href="#" data-dismiss="modal"><i class="aficon-times"></i></a>
				</div>
				<div class="modal-body">
					...
					<div class="form-group has-feedback">
						<label for="res_email" class="bold"><?php esc_html_e( 'Email *', 'adifier' ) ?></label>
						<input type="text" class="form-control" id="res_email" name="res_email" placeholder="<?php esc_attr_e( 'Your registered email', 'adifier' ) ?>" />
					</div>

					<?php do_action( 'adifier_recaptcha_field' ) ?>
					
					<a href="javascript:;" class="submit-ajax-form af-button"><?php esc_html_e( 'Resend', 'adifier' ) ?> </a>
