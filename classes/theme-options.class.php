    ...
    class Adifier_Options {
        ...
        protected function _load_sections()
        {
            ...
            $this->_sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'type'      => 'text',
                        'desc'      => esc_html__('Input how many times user can try to login or leave empty to disable', 'adifier'),
                    ),
                    array(
                        'id'        => 'login_attempt_block_time',
                        'title'     => esc_html__( 'Login Lock Time', 'adifier' ),
                        'type'      => 'text',
                        'desc'      => esc_html__('Input how many hours user will be blocked from login ( Default is 3 hours )', 'adifier'),
                    ),
                )
            );
            ...
            $this->_sections[] = array(
                ...
                'fields'    => array(
                    array(
                        ...
                        'desc'      => esc_html__('Register your application on https://developers.facebook.com/apps/', 'adifier').'<br/>'.
                                        sprintf( esc_html__( 'Callback URL: %sindex.php?adifier-callback=facebook', 'adifier' ), home_url('/') ).'<br />'.
                                        sprintf( esc_html__( 'Delete Callback URL: %sindex.php?adifier-facebook-delete=1', 'adifier' ), home_url('/') ),
                    ),
                    array(
                        'id'        => 'facebook_app_id',
                        'type'      => 'text',
            ...
            **********************************************************************/
            ...
            $this->_sections[] = array(
                'title'     => esc_html__('reCaptcha v3', 'adifier') ,
                'icon'      => '',
                'desc'      => esc_html__('Set up reCaptcha v3 API. Visit https://www.google.com/recaptcha/admin/create', 'adifier'),
                'fields'    => array(
                    array(
                        'id'        => 'recaptcha_site_key',
                        'type'      => 'text',
                        'title'     => esc_html__('Site Key', 'adifier') ,
                        'desc'      => esc_html__('Type your site api key.', 'adifier')
                    ) , 
                    array(
                        'id'        => 'recaptcha_secret_key',
                        'type'      => 'text',
                        'title'     => esc_html__('Secret Key', 'adifier') ,
                        'desc'      => esc_html__('Type your secret api key.', 'adifier')
                    ) ,
                )
            );
