	...
	<form id="posts-filter" method="post" action="<?php echo esc_url( add_query_arg(null, null) ); ?>">
		...
		<div class="tablenav top">
			...
			<p class="search-box">
				...
				<input id="post-search-input" name="s" value="" type="search" placeholder="<?php esc_html_e( 'Filter by ad', 'adifier' ) ?>">
			...
			<thead>
				<tr>
					...
					<td scope="col" id="title" class="manage-column column-title column-primary" style="">
						<?php esc_html_e( 'Users', 'adifier' ) ?>
					</td>
					<td scope="col" id="title" class="manage-column column-title column-primary" style="">
						<?php esc_html_e( 'Ad', 'adifier' ) ?>
					</td>					
				</tr>
			</thead>
						...
						<tr class="hentry alternate">
							...
							<td class="title column-title column-primary page-title">
								<a href="<?php echo esc_url( add_query_arg( array('con_id' => $conversation->con_id) ) ) ?>">
									<?php echo get_the_author_meta( 'display_name', $conversation->sender_id ).' | '.get_the_author_meta( 'display_name', $conversation->recipient_id ); ?>
								</a>
							</td>
							<td class="title column-title column-primary page-title">
								<a href="<?php echo esc_url( get_the_permalink( $conversation->post_id ) ) ?>" target="_blank">
									<?php  echo $conversation->advert_title; ?>
								</a>
							</td>							
						</tr>
						<?php
