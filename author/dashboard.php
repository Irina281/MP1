<div class="author-panel dashboard-wrap">
	...
	<div class="row">
		...
		<?php if( $advert_comments == 'yes' ): ?>
			<div class="col-sm-6">
				<h5><?php esc_html_e( 'Unread Comments', 'adifier' ) ?></h5>
				<?php adifier_unread_comments() ?>
			</div>
		<?php endif;?>
		<div class="col-sm-<?php echo $advert_comments == 'yes' ? '6' : '12' ?>">
			...
			<div class="white-block-title">
				<div class="flex-wrap flex-center">
					...
					<div class="styled-select margin-above">
						<select class="advert-chart-months" disabled="disabled"></select>
					</div>
				</div>
			</div>
			<div class="white-block-content">
