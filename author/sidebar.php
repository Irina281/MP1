<div class="author-sidebar">
	<div>
		<div class="user-details text-center">
			...
			<div class="text-center user-details-list">
				<a href="<?php echo esc_url( add_query_arg( 'screen', 'profile', $author_url ) ) ?>" title="<?php esc_html_e( 'Settings', 'adifier' ) ?>">
					...
					<span class="icon-caption"><?php esc_html_e( 'Settings', 'adifier' ) ?></span>
				</a>
				<a href="<?php echo esc_url( add_query_arg( 'screen', 'messages', $author_url ) ) ?>" title="<?php esc_html_e( 'Messages', 'adifier' ) ?>">
					...
					<span class="icon-caption"><?php esc_html_e( 'Messages', 'adifier' ) ?></span>
				</a>
				<a href="<?php echo esc_url( wp_logout_url( home_url('/') ) ) ?>" title="<?php esc_html_e( 'Logout', 'adifier' ) ?>">
					<i class="aficon-logout"></i>
					<span class="icon-caption"><?php esc_html_e( 'Logout', 'adifier' ) ?></span>
				</a>
			</div>
		</div>
		<ul class="list-unstyled author-sidebar-list">
			...
			<?php if( adifier_get_option('account_payment') != 'free' || adifier_get_option( 'enable_promotions' ) != 'no' ): ?>			
			<li class="author-sidebar-title">
			...
			<li>
				<a href="javascript:;" class="delete-acc" data-confirm="<?php esc_attr_e( 'Are you sure that you want to delete your account and everything associated with it?', 'adifier' ) ?>" data-url="<?php echo esc_url( add_query_arg( ['screen' => 'delete-acc', 'token' => wp_create_nonce('delete-acc')], $author_url ) ) ?>">
