...
$author_meta = array(
	...
	'hide_phone'	=> get_user_meta( $author->ID, 'hide_phone', true ),
				...
				<div class="white-block-content">
					<form class="ajax-form">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label for="first_name"><?php !empty( $mandatory_fields['first_name'] ) ? esc_html_e( 'First Name *', 'adifier' ) : esc_html_e( 'First Name', 'adifier' ) ?></label>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="last_name"><?php !empty( $mandatory_fields['last_name'] ) ? esc_html_e( 'Last Name *', 'adifier' ) : esc_html_e( 'Last Name', 'adifier' ) ?></label>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<div class="flex-wrap">
										<label for="phone"><?php !empty( $mandatory_fields['phone'] ) ? esc_html_e( 'Phone *', 'adifier' ) : esc_html_e( 'Phone', 'adifier' ) ?></label>
										<div class="styled-checkbox negotiable-checkbox">
											<input type="checkbox" id="hide_phone" name="hide_phone" value="1" <?php checked( 1, $hide_phone ) ?>>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="website" id="website" value="<?php echo esc_attr( $website ); ?>" placeholder="<?php esc_attr_e( 'Link to your site', 'adifier' ); ?>">
								</div>
							</div>
						</div>						
								...
								if( $location_selection == 'combined' ){
									...
									if( !empty( $locations ) ){
										...
										<select name="location_id" id="location_id" class="select2-enabled">
											...
											<?php
											if( !empty( $locations ) ){
												addifier_hierarchy_select_taxonomy( $locations, 0, (array)$af_location_id );
											}
											?>
										</select>                   
										<?php
									...
									adifier_taxonomy_multifilter( esc_html__( 'Location *', 'adifier' ), 'location_id', 'advert-location', $af_location_id, false );
								}
							?>
							</div> 
							<?php
			...
			<div class="white-block white-block-extra-padding">
				...
				<div class="white-block-content">
					<form class="ajax-form">
						...
						<div class="form-group relative-wrap">
							<label for="new_password"><?php esc_html_e( 'New Password *', 'adifier' ) ?> <span class="pw-strength"></span></label>
							<input type="password" name="new_password" id="new_password" class="reveal-password pw-check-strength" value="" placeholder="<?php esc_attr_e( 'Your desired new password', 'adifier' ); ?>">
							<a href="javascript:;" title="<?php esc_attr_e( 'View Password', 'adifier' ) ?>" class="toggle-password"><i class="aficon-eye"></i></a>
						</div>
